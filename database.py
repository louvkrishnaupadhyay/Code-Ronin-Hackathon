...
class Database:
    ...
    def search_entry(self, embedding, threshold=0.7):
        """
        Searches for the most similar embedding in the dictionary.
        Uses cosine similarity since vectors are L2-normalized.
        ...
        # Compare with all stored embeddings across all classes
